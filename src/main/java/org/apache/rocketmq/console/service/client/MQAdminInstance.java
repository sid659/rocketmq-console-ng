...
import org.apache.rocketmq.console.config.ConsoleConfig;
...
public class MQAdminInstance {
    ...
    public static MQAdminExt threadLocalMQAdminExt() {
        ...
        //jiang
        //defaultMQAdminExt.setUseTLS(config.getUserTls());
    ...
    public static void initMQAdminInstance(long timeoutMillis, Boolean isUserTls) throws MQClientException {
        ...
        if (nowCount == null) {
            ...
            //jiang
            defaultMQAdminExt.setUseTLS(isUserTls);
